  ...
  return (
    <div>
      ...
      <div className="body">
        ...
        <p id="paragraph">
          e-water for All is an electronic solution for mentioned problems. We
          provide decision-makers with accurate information.<br/> We bring people and
          organizations together. We campaign for more and better-targeted
          investment.<br/> And we empower communities so that the Government hears
          their voices
        </p>

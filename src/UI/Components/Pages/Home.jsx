  ...
  return (
    <div>
      ...
      <div className="middle-side">
        ...
        <Link to="/impact" id="button-explore">
          Explore
        </Link>
      </div>
      <div className="midle-text">
        <div className="midle-text1">
          ...
          <p className="paragraph">
            E-water for All provide decision-makers with accurate information.
            <br /> We bring people and organizations together. We campaign for
            more <br />
            and better-targeted investment. And we empower communities so
            <br /> that the Government hears their voices
          </p>
        </div>
      ...
      <div className="midle-text-2">
        ...
        <div className="midle-text-3">
          <p className="paragraph2">
            Water service providers will have an option of registering new taps,<br/>
            locations, and reporting the issue shared by citizens. Admin will<br/>
            have an option of controlling what citizens and water service<br/>
            providers do and providing feedback
            <br />
            Volutpat enim.
          </p>
          <div className="battons">
            <Link to="/request" className="buton">
              Request
            </Link>
